...
| `platform-workspace-entry-api` | `codex/platform-workspace-entry-api` | Conditional follow-up | Not ready | Do not start until REQ-002 completion report confirms missing API exposure | Web adapter, Host wiring, Platform application query exposure |
